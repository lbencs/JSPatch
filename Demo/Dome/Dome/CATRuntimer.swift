...
extension NSObject {
    public class func at_allIvars() -> [CATIvar] {
        var ivars = [CATIvar]()
        var count: UInt32 = 0
        let ivarList: UnsafeMutablePointer<Ivar> = class_copyIvarList(self.classForCoder(), &count)
